...
CONFIG = {
    ...
    "rubric_sheet": "Rubric",
    "submission_file": "Assign 3A Cleaned Merged for Assessment.xlsx",
    "id_column": "username",
    "output_csv": "MGMT4901_3A_Evaluation_Output.csv"
}
...
Your task is to:
1. Write a 1 sentence comment on the student's performance in this category
